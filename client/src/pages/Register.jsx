...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Optionally redirect after a few seconds or let user click button
        ...
        <div className="auth-page">
            <div className="auth-container">
                ...
                <div className="auth-form-container">
                    {isRegistered ? (
                        <div className="auth-form-wrapper" style={{ textAlign: 'center', padding: '2rem' }}>
                            <div style={{ fontSize: '5rem', marginBottom: '1rem' }}>🎉</div>
                            <h2 style={{ fontSize: '2rem', color: 'var(--primary)', marginBottom: '1rem' }}>
                                Cadastro Ativo!
                            </h2>
                            <p style={{ fontSize: '1.2rem', color: 'var(--text-secondary)', marginBottom: '2rem' }}>
                                Seja bem-vindo ao <strong>Kalq.me</strong>!<br /> 
                                Sua conta foi criada com sucesso e você já pode começar a organizar seu MEI.
                            </p>
                            <button 
